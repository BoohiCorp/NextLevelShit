...
export default function CircularNavigation({
	...
	return (
		<nav className="flex flex-wrap items-center justify-between w-full md:w-fit p-2 md:p-1 gap-4 md:gap-20 md:rounded-full md:px-8 mx-auto mt-4 backdrop-blur-sm md:backdrop-blur-none">
			<Link href="/" className="flex items-center space-x-2">
				<div className="bg-slate-50 dark:bg-slate-900 p-1 rounded-full">
					<CalendarDaysIcon className="size-8 transition-transform duration-300 ease-in-out hover:scale-110" />
				</div>
